...
<div class="noise-container">
  <div class="noise"></div>
  <footer class="w-full bg-[#101010]">
    <div class="w-full max-w-screen-2xl mx-auto p-2 px-6 xs:px-12">
      <nav
        aria-label="Secondary"
        class="flex flex-col items-start text-white font-medium text-lg justify-between gap-12 py-8 sm:flex-row-reverse md:py-12"
      >
        ...
        <div
          class="grid grid-cols-2 gap-12 sm:flex sm:flex-wrap sm:gap-16 lg:gap-20 text-white font-medium text-lg"
        >
          <section class="group flex flex-col text-white font-medium text-lg">
            <svg
              viewBox="0 0 129 25"
              class="w-[8.5rem]"
              fill="none"
          ...
          <section class="group flex flex-col text-white font-medium text-lg">
            <h2
              id="footerHeading1"
              class="code mb-4 text-xl leading-none opacity-50"
            >
              Community
            </h2>
            <ul aria-labelledby="footerHeading0" class="flex flex-col gap-2">
              <li>
                <a href="/" class="link whitespace-nowrap"> Incentives </a>
              </li>
              <li>
                <a href="/" class="link whitespace-nowrap"> Challenges </a>
              </li>
            </ul>
          </section>
          <section class="group flex flex-col text-white font-medium text-lg">
            ...
            <ul aria-labelledby="footerHeading0" class="flex flex-col gap-2">
              <li>
                <a href="/" class="link whitespace-nowrap"> Team </a>
              </li>
              <li>
                <a href="/" class="link whitespace-nowrap"> Ideas </a>
              </li>
              <li>
                <a href="/themes/" class="link whitespace-nowrap">
                  Collaborations
                </a>
              </li>
            </ul>
      ...
      >
        <a class="link text-white font-medium text-lg" href="/privacy">
          Privacy Policy
        </a>
        <a class="link mr-auto text-white font-medium text-lg" href="/terms">
          Terms of Service
        </a>
        <p
          class="col-span-2 text-center md:col-span-1 text-white font-medium text-lg"
        >
          © 2023{" "}
          <span class="link" target="_blank"> Marble </span>
        </p>
      </nav>
    </div>
  </footer>
